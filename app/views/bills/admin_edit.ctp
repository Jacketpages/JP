	...
	<div class="bills form">
		...
		<fieldset>
			<?php
				...
				echo $this -> Form -> input('fundraising');
			...
			<?php echo $this -> Form -> input('grad_pres_sign', array(
						...
						'options' => array(
								$bill['Bill']['grad_pres_sign'] => $bill['Bill']['grad_pres_sign'],
				...
				echo $this -> Form -> input('grad_secr_sign', array(
						...
						'options' => array(
								$bill['Bill']['grad_secr_sign'] => $bill['Bill']['grad_secr_sign'],
								'Not Yet Signed' => 'Not Yet Signed',
								$username => $username
						)
				));
				echo $this -> Form -> input('ungr_pres_sign', array(
						...
						'options' => array(
								$bill['Bill']['ungr_pres_sign'] => $bill['Bill']['ungr_pres_sign'],
								'Not Yet Signed' => 'Not Yet Signed',
								$username => $username
						)
				));
				echo $this -> Form -> input('ungr_secr_sign', array(
						...
						'options' => array(
								$bill['Bill']['ungr_secr_sign'] => $bill['Bill']['ungr_secr_sign'],
								'Not Yet Signed' => 'Not Yet Signed',
								$username => $username
						)
				));
				echo $this -> Form -> input('vp_fina_sign', array(
						...
						'options' => array(
								$bill['Bill']['vp_fina_sign'] => $bill['Bill']['vp_fina_sign'],
								'Not Yet Signed' => 'Not Yet Signed',
								$username => $username
						)
				));
