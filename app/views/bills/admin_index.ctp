...
?>
<?php echo $this -> Html -> addCrumb('All Bills', '/admin/bills/index/All');?>
<div id="sidebars" class="action">
	<ul>
		...
		<li>
			<?php echo $this -> Html -> link(__('New Bill', true), array('action' => 'add'));?>
		</li>
		<li>
...
<div id="middle">
	<div id="post bills form type-post"></div>
	<h3>Bills</h3>
	<?php
	...
	<div id="listing">
		<table cellpadding="0" cellspacing="0">
			<tr>
				<th width="40%"><?php echo $this -> Paginator -> sort('title');?></th>
				<th width="15%"><?php echo $this -> Paginator -> sort('category');?></th>
				<th width="15%"><?php echo $this -> Paginator -> sort('status');?></th>
				<th width="10%"><?php echo $this -> Paginator -> sort('submit_date');?></th>
...
$class = 'class="altrow"';
			...
			<tr <?php echo $class;?>>
				...
				?>&nbsp;</td>
				<td><?php echo $bill['Bill']['category'];?>&nbsp</td>
