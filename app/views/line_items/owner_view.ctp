...
<?php echo $this->Html->addCrumb($lineItem['Bill']['title'], '/owner/bills/view/'.$lineItem['Bill']['id']); ?>
<div id="sidebars">
	<ul>
		<li><?php echo $this->Html->link(__('Delete Line Item', true), array('action' => 'delete', 'owner' => false, $lineItem['LineItem']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $lineItem['LineItem']['id'])); ?>
		</li>
		<li><?php echo $this->Html->link(__('New Line Item', true), array('action' => 'add', $lineItem['LineItem']['bill_id'])); ?>
		</li>
	</ul>
