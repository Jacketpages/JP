...
<div id="sidebars">
	<ul>
		<li><?php echo $this->Html->link(__('Edit Line Item', true), array('action' => 'edit', $lineItem['LineItem']['id'])); ?>
		</li>
		...
		<li><?php echo $this->Html->link(__('New Line Item', true), array('action' => 'add')); ?>
		</li>
...
<div id="middle">
	<div class="lineItems view">
		...
		<?php $i = 0; $class = ' class="altrow"';?>
			...
			<?php echo $this->Html->link($lineItem['Parent2']['name'], array('controller' => 'line_items', 'action' => 'view', $lineItem['Parent2']['id'])); ?>
				&nbsp;
			</dd>
			<dt    <?php if ($i % 2 == 0) echo $class;?>>
...
<?php endif; ?>
	...
	<div class="actions">
		<ul>
			<li><?php echo $this->Html->link(__('New Children', true), array('controller' => 'line_items', 'action' => 'add'));?> </li>
		</ul>
	</div>
</div>
</div>
